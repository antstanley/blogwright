...
- `.specs/README.md`'s Change specs section is the index readers follow to reach every spec → expect the two moved specs to be reachable at their new depth, and the pds spec's pending link still to resolve at the old one : ☐ (PRESERVED / REGRESSION)

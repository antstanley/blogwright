...
**Implements:** [2026-07-26-analytics_plugin.md §`blogwright-core` → `LogsClient` delivery configuration (Modify)](../../../changes/merged/2026-07-26-analytics_plugin.md) ("Both are optional and default to today's behaviour, so the site's existing CloudWatch delivery is unchanged")
**Depends on:** -

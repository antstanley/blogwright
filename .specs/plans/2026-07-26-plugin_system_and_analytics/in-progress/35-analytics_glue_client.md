...
- [ ] Reviewable: run `pnpm --filter blogwright-analytics exec vitest run glue --reporter=verbose`; confirm the suite covers present, absent, already-exists and non-not-found, and that the class body declares no third public method.
